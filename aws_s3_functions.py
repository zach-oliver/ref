...
def upload_File_To_S3_From_Local(str_bucket_name, str_local_dir, str_bucket_object_key, DEBUG=False):
    if DEBUG:
        print 'aws_s3_functions.py |:| upload_File_To_S3: START'
        print 'aws_s3_functions.py |:| upload_File_To_S3: str_bucket_name=%s' % (str(str_bucket_name))
        print 'aws_s3_functions.py |:| upload_File_To_S3: str_local_dir=%s' % (str(str_local_dir))
        print 'aws_s3_functions.py |:| upload_File_To_S3: str_local_dir type is %s' % (str(mimetypes.guess_type(str_local_dir)[0]))
        print 'aws_s3_functions.py |:| upload_File_To_S3: str_bucket_object_key=%s' % (str(str_bucket_object_key))
    
    s3_bucket = boto3.resource('s3').Bucket(str_bucket_name)
    
    if DEBUG:
        print 'aws_s3_functions.py |:| upload_File_To_S3: s3 BUCKET RESOURCE INSTANTIATED'
    try:
    ...
    if DEBUG:
        print 'aws_s3_functions.py |:| upload_File_To_S3: s3 BUCKET OBJECT CREATED'
        print 'aws_s3_functions.py |:| upload_File_To_S3: FINISH'
...
def delete_S3_Object(str_bucket_name, str_bucket_object_key, DEBUG=False):
    if DEBUG:
        print 'aws_s3_functions.py |:| delete_S3_Object: START'
        print 'aws_s3_functions.py |:| delete_S3_Object: str_bucket_name=%s' % (str(str_bucket_name))
        print 'aws_s3_functions.py |:| delete_S3_Object: str_bucket_object_key=%s' % (str(str_bucket_object_key))
    s3_bucket = boto3.resource('s3').Bucket(str_bucket_name)
    if DEBUG:
        print 'aws_s3_functions.py |:| delete_S3_Object: s3 RESOURCE INSTANTIATED'
    try:
        ...
        if e.response['Error']['Code'] == "404":
            if DEBUG:
                print 'aws_s3_functions.py |:| delete_S3_Object: s3 OBJECT DOESNT EXIST'
                print 'aws_s3_functions.py |:| delete_S3_Object: FINISH'
            return False
        else:
            raise
            return False
    ...
    if DEBUG:
        print 'aws_s3_functions.py |:| delete_S3_Object: s3 OBJECT DELETED'
        print 'aws_s3_functions.py |:| delete_S3_Object: FINISH'
...
def download_S3_Object(str_bucket_name, str_bucket_object_key, str_local_dir, DEBUG=False):
    if DEBUG:
        ...
        print 'aws_s3_functions.py |:| download_S3_Object: str_bucket_name=%s' % (str(str_bucket_name))
        print 'aws_s3_functions.py |:| download_S3_Object: str_bucket_object_key=%s' % (str(str_bucket_object_key))
        print 'aws_s3_functions.py |:| download_S3_Object: str_local_dir=%s' % (str(str_local_dir))
    else:
...
def get_S3_Bucket_Object_Info(str_bucket_name, str_bucket_object_key, DEBUG=False):
    if DEBUG:
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Info: START'
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Info: str_bucket_name=%s' % (str(str_bucket_name))
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Info: str_bucket_object_key=%s' % (str(str_bucket_object_key))
    
    try:
        s3_object_summary = boto3.resource('s3').ObjectSummary(str_bucket_name, str_bucket_object_key)
    
        if DEBUG:
            print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Info: s3 OBJECT SUMMARY INSTANTIATED'
    except botocore.exceptions.ClientError as e:
        if e.response['Error']['Code'] == "404":
            if DEBUG:
                print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Info: s3 OBJECT DOESNT EXIST'
                print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Info: FINISH'
            return False
        else:
            raise
            return False
    ...
    if DEBUG:
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Info: s3 BUCKET OBJECT SUMMARY COLLECTED'
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Info: FINISH'
...
def get_S3_Bucket_Object_Last_Modified_Date(str_bucket_name, str_bucket_object_key, DEBUG=False):
    if DEBUG:
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Last_Modified_Date: START'
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Last_Modified_Date: str_bucket_name=%s' % (str(str_bucket_name))
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Last_Modified_Date: str_bucket_object_key=%s' % (str(str_bucket_object_key))
    
    try:
        if DEBUG:
            print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Last_Modified_Date |:| get_S3_Bucket_Object_Info'
        ...
        if DEBUG:
            print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Last_Modified_Date |:| get_S3_Bucket_Object_Info: FINISHED'
    except botocore.exceptions.ClientError as e:
        if e.response['Error']['Code'] == "404":
            if DEBUG:
                print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Last_Modified_Date: s3 OBJECT DOESNT EXIST'
                print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Last_Modified_Date: FINISH'
            return 0
        else:
            raise
            return 0
    ...
    if DEBUG:
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Last_Modified_Date: s3 BUCKET OBJECT LAST MODIFIED DATE COLLECTED'
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Last_Modified_Date: FINISH'
...
def get_S3_Bucket_Object_Size(str_bucket_name, str_bucket_object_key, DEBUG=False):
    if DEBUG:
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Size: START'
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Size: str_bucket_name=%s' % (str(str_bucket_name))
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Size: str_bucket_object_key=%s' % (str(str_bucket_object_key))
    
    try:
        if DEBUG:
            print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Size |:| get_S3_Bucket_Object_Info'
        size = get_S3_Bucket_Object_Info(str_bucket_name, str_bucket_object_key).size
    
        if DEBUG:
            print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Size |:| get_S3_Bucket_Object_Info: FINISHED'
    except botocore.exceptions.ClientError as e:
        if e.response['Error']['Code'] == "404":
            if DEBUG:
                print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Size: s3 OBJECT DOESNT EXIST'
                print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Size: FINISH'
            return 0
        else:
            raise
            return 0
    ...
    if DEBUG:
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Size: s3 BUCKET OBJECT SIZE COLLECTED: %i' % (size)
        print 'aws_s3_functions.py |:| get_S3_Bucket_Object_Size: FINISH'
